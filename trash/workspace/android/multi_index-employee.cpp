...
struct employee
{
  ...
  friend std::ostream& operator<<(std::ostream& os,const boost::shared_ptr<employee>& e)
  {
...
int main()
{
  ...
  es.insert(boost::make_shared<employee>(0,"Joe",31));
  es.insert(boost::make_shared<employee>(1,"Robert",27));
  es.insert(boost::make_shared<employee>(2,"John",40));

  /* next insertion will fail, as there is an employee with
   * the same ID
   */

  es.insert(boost::make_shared<employee>(2,"Aristotle",2387));

  es.insert(boost::make_shared<employee>(3,"Albert",20));
  es.insert(boost::make_shared<employee>(4,"John",57));
