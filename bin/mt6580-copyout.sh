...
echo    "copy $objCGEN to $outdb" ; cp -vt $outdb $objCGEN
echo    "copy $objETC to $outdb" ; cp -vt $outdb $objETC
echo "copy $lunch to $out" ; find $lunch -maxdepth 1 -type f | xargs cp -vt $out 
