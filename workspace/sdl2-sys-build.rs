...
fn download_sdl2() -> PathBuf {
  ...
  //let sdl2_archive_url = format!("http://libsdl.org/release/{}", sdl2_archive_name);
    let sdl2_archive_url = format!("http://127.0.0.1:8000/{}", sdl2_archive_name);
    println!("sdl2_archive_url: {}", sdl2_archive_url);
...
fn compile_sdl2(sdl2_build_path: &Path, target_os: &str) -> PathBuf {
    if target_os.contains("android") {
        env::set_var("CMAKE", "/opt/android-sdk/cmake/3.6.4111459/bin/cmake");
    }
    ...
    if target_os.contains("android") {
        cfg.generator("Android Gradle - Ninja")
            .define("ANDROID_ABI", "arm64-v8a")
            .define("ANDROID_NDK", "/opt/android-ndk")
            .define("CMAKE_BUILD_TYPE", "Release")
            .define("CMAKE_MAKE_PROGRAM", "/opt/android-sdk/cmake/3.6.4111459/bin/ninja")
            .define("CMAKE_TOOLCHAIN_FILE", "/opt/android-ndk/build/cmake/android.toolchain.cmake")
            .define("ANDROID_PLATFORM", "android-17")
            ;
    }
