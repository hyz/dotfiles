...
adr='rtsp://127.0.0.1:7654/test1-rtsp' #"rtsp://admin:12345@192.168.1.74" # username, passwd, etc.
clientports=[60784,60785] # the client ports we are going to use for receiving video
fname="rtp-cli-stream.data" # filename for dumping the stream
...
s.connect((ip,7654)) # RTSP should peek out from port 554
