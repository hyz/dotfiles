...
if __name__ == '__main__':
    params = {
        'password'  : '2256f2b4bfe7e6ada10c0bbc123a1445',
...
#curl -v -c cook -b cook http://api.moon.kklink.com/checkversion \
#    -d password=2256f2b4bfe7e6ada10c0bbc123a1445 -d bundleid=com.kklnk.yx -d autoLogin=0 \
