...
//
//arch: make clean -C src/2bwm ; rm -f 2bwm-*.pkg.tar.xz ; makepkg --noextract
//
...
static key keys[] = {
    ...
    {  MOD |SHIFT,        XK_Tab,        focusnext,         {.i=0}},
    {  MOD       ,        XK_Tab,        focusnext,         {.i=1}},
    {  MOD       ,        XK_k  ,        focusnext,         {.i=0}},
    {  MOD       ,        XK_j  ,        focusnext,         {.i=1}},
    // Kill a window
  ...
  //{  MOD |SHIFT|CONTROL,XK_h,          resizestep,        {.i=4}},
    // Move a window
    {  MOD ,              XK_Up    ,     movestep,          {.i=2}},
    {  MOD ,              XK_Down  ,     movestep,          {.i=1}},
    {  MOD ,              XK_Right ,     movestep,          {.i=3}},
    {  MOD ,              XK_Left  ,     movestep,          {.i=0}},
  //// Move a window slower
  //{  MOD |CONTROL,      XK_Up    ,     movestep,          {.i=6}},
  //{  MOD |CONTROL,      XK_Down  ,     movestep,          {.i=5}},
  //{  MOD |CONTROL,      XK_Right ,     movestep,          {.i=7}},
  //{  MOD |CONTROL,      XK_Left  ,     movestep,          {.i=4}},
    ...
    {  MOD       ,        XK_5   ,       resizestep_aspect, {.i=0}},
    {  MOD |SHIFT,        XK_5   ,       resizestep_aspect, {.i=1}},
  //{  MOD ,              XK_Home,       resizestep_aspect, {.i=0}},
  //{  MOD ,              XK_End,        resizestep_aspect, {.i=1}},
  //// Full screen window without borders
    {  MOD ,              XK_F11,        fullscreen,        {.i=0}},
  //// Full screen window without borders overiding offsets
  //{  MOD |SHIFT ,       XK_x,          fullscreen,        {.i=1}},
  //// Maximize vertically
    {  MOD ,              XK_v,          maxvert_hor,       {.i=1}},
  //{  MOD ,              XK_m,          maxvert_hor,       {.i=1}},
  //// Maximize horizontally
    {  MOD       ,        XK_h,          maxvert_hor,       {.i=0}},
  //{  MOD |SHIFT,        XK_m,          maxvert_hor,       {.i=0}},
    {  MOD       ,        XK_F6,         maxhalf,           {.i=0}},
    {  MOD       ,        XK_F7,         maxhalf,           {.i=1}},
    {  MOD       ,        XK_F7,         maxhalf,           {.i=2}},
    // Maximize and move
  //// vertically left
  ...
  //{  MOD |SHIFT,        XK_Left,       cursor_move,       {.i=3}},
    ...
    {  MOD       ,        XK_Return,     start,             {.com = gmrun}},
  //{  MOD       ,        XK_Return,     start,             {.com = menucmd}},
  ...
  //{  MOD |CONTROL,      XK_Right,      start,             {.com = click3}},
    ...
    {  MOD       ,        XK_0,          nextworkspace,     {.i=0}},
    {  MOD       ,        XK_9,          prevworkspace,     {.i=0}},
  //{  MOD |SHIFT,        XK_v,          nextworkspace,     {.i=0}},
  //{  MOD |SHIFT,        XK_c,          prevworkspace,     {.i=0}},
    // Move to Next/Previous workspace
    {  MOD |SHIFT,        XK_0,          sendtonextworkspace,     {.i=0}},
    {  MOD |SHIFT,        XK_9,          sendtoprevworkspace,     {.i=0}},
